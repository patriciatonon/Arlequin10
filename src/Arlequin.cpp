...
template <int DIM>
void Arlequin<DIM>::setCorrespondenceFine_ISO_ISO()
{
...
template <int DIM>
void Arlequin<DIM>::printResultsLaplace_ISO_ISO(int step)
{
...
template <int DIM>
void Arlequin<DIM>::printResultsIP_ISO_ISO(int step)
{
